...
func TestString(t *testing.T) {
	...
	t.Run("Empty", func(t *testing.T) {
		wrapped := Empty
		wrappedPtr := *Empty
		assert.Equal(t, stringsx.Empty, wrapped.String())
		assert.Equal(t, stringsx.Empty, wrappedPtr.String())
	})
...
func TestWrapGet(t *testing.T) {
	...
	t.Run("Get non-existent key", func(t *testing.T) {
		...
		assert.Equal(t, stringsx.Empty, missing.String())
...
func TestRefString(t *testing.T) {
	...
	t.Run("Empty", func(t *testing.T) {
		wrapped := Empty
		assert.Equal(t, stringsx.Empty, wrapped.RefString())
	})
...
func TestWrapIndex(t *testing.T) {
	...
	t.Run("Get out of bounds index", func(t *testing.T) {
		...
		assert.Equal(t, stringsx.Empty, outOfBounds.String())
	})
